   ...
   <search
    ...
    <group gutter="0">
      <cell    v-for="(item,index) in lists"  style="border-top:0px;">
       <span slot="title" ><img class="circle" v-bind:src="apiPrefix+'/'+item.image"  style="vertical-align:middle;width:30px;height:30px;"/>&nbsp;<span style="vertical-align:middle;font-size:16px;color:#09BB07">{{item.name}}：<span style="color:black;font-size:14px;">{{item.theme}}</span></span></span>
